...
private _allposts = (nearestObjects [_squadpos, ["Land_Cargo_Patrol_V1_F","Land_Cargo_Patrol_V2_F","Land_Cargo_Patrol_V3_F","Land_Cargo_Patrol_V4_F", "Land_Posed", "land_wx_guardtower_02"], GRLIB_capture_size]) select {alive _x};
