...
switch (KP_liberation_arsenal) do {
    ...
    case 12: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\WWII_German.sqf";};
    case 13: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\WWII_Western_Allied.sqf";};
