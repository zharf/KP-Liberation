switch (KP_liberation_preset_blufor) do {
    ...
    case 28: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\WWII_German.sqf";};
    case 29: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\WWII_Soviet.sqf";};
    case 30: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\WWII_Western_Allied.sqf";};
...
switch (KP_liberation_preset_opfor) do {
    ...
    case 18: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\WWII_Soviet.sqf";};
    case 19: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\WWII_German.sqf";};
...
switch (KP_liberation_preset_resistance) do {
    ...
    case  9: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\WWII_Polish.sqf";};
    case 10: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\WWII_German.sqf";};
...
switch (KP_liberation_preset_civilians) do {
    ...
    case  8: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\WWII_Citizens.sqf";};
...
{friendly_infantry_classnames pushBackUnique _x;} forEach (blufor_squad_inf_light + blufor_squad_inf + blufor_squad_at + blufor_squad_recon + blufor_squad_para);
