switch (KP_liberation_preset_blufor) do {
	...
	case 16: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\WWII_Soviet.sqf";};
	case 17: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\WWII_Western_Allied.sqf";};
...
switch (KP_liberation_preset_opfor) do {
	...
	case 13: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\WWII_German.sqf";};
...
switch (KP_liberation_preset_resistance) do {
	...
	case 7: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\WWII_German.sqf";};
...
switch (KP_liberation_preset_civilians) do {
	...
	case 5: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\WWII_Citizens.sqf";};
