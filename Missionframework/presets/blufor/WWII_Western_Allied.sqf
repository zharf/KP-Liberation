...
KP_liberation_truck_classname = "LIB_usa_GMC_CCKW353cf_KakiOpen";	// These are the trucks which are used in the logistic convoy system.																	Default is "B_Truck_01_transport_F".
